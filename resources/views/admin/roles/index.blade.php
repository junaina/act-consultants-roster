...
@section('content')
    <div class="w-full max-w-screen-xl px-8 py-10">
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-10">
            ...
            <form action="{{ route('admin.users.roles.store') }}" method="POST" class="flex flex-col sm:flex-row gap-4">
                @csrf
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <form action="{{ route('admin.users.roles.destroy', $role->id) }}" method="POST"
