...
@section('content')
    <div class="max-w-screen-xl mx-auto px-8 py-6">
        ...
        <div class="flex flex-wrap gap-3 mb-6">
            @if (Route::is('admin.users.areas.index'))
        ...
        <!-- Add New Area Button -->
        <div class="mb-4">
            <a href="{{ route('admin.users.areas.create') }}"
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center flex-wrap gap-2">
                                    ...
                                    <a href="{{ route('admin.users.areas.edit', $area->id) }}"
                                        class="px-3 py-1 text-sm rounded-md bg-yellow-100 text-yellow-800 hover:bg-yellow-200 transition">
                                        Edit
                                    </a>

                                    <form action="{{ route('admin.users.areas.destroy', $area->id) }}" method="POST"
                                ...
                                @if (session('delete_error_id') == $area->id)
