...
<div class="max-w-md mx-auto mt-12 bg-white p-8 rounded shadow">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
        ...
        <div>
            ...
            <input id="full_name" type="text" name="full_name" value="<?php echo e(old('full_name')); ?>" required autofocus
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center text-sm text-gray-600">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-red-600 hover:underline">Log in here</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internships\act-projects\registration-form\registration-form\resources\views/auth/register.blade.php ENDPATH**/ ?>