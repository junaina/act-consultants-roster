<?php $__env->startSection('welcome-page-content'); ?>
    <style>
        .carousel-container {
            perspective: 1000px;
        ...
        <div class="w-full max-w-6xl mx-auto">
            ...
            <div class="carousel-container relative">
                ...
                <div class="carousel-track relative h-[400px] sm:h-[500px] md:h-[600px] overflow-hidden">
                    ...
                    <?php for($i = 1; $i <= 6; $i++): ?>
                        <div class="carousel-item <?php echo e($i === 1 ? 'active' : 'hidden'); ?> absolute top-0 left-0 w-full h-full">
                            <div class="w-full h-full p-4 sm:p-8">
                                <div class="w-full h-full rounded-xl sm:rounded-2xl overflow-hidden relative group">
                                    <img src="<?php echo e(asset("images/carousel/carousel-image$i.jpg")); ?>"
                ...
                <div class="absolute bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 flex gap-1 sm:gap-2 z-20">
                    <?php for($i = 0; $i < 6; $i++): ?>
                        <button
                            ...
                            title="Go to slide <?php echo e($i + 1); ?>"></button>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\internships\act-projects\registration-form\registration-form\resources\views/welcome.blade.php ENDPATH**/ ?>